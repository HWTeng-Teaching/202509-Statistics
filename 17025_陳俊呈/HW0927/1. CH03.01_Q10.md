...
The stacked bar chart can describe not only the total frequency of Boys and Girls, which can help to read the total frequency between Boys and Girls, but also shows the comparison of having cell phone and no cell phone. <br>
...
The side-by-side bar chart compares the frequency of having cell phone and no cell phone between Boys and Girls from the bottom, which can read the comparison result in a same level. <br>
